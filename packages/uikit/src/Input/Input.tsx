  ...
  return (
    ...
    >
      ...
      <Show when={local.description}>
        <KTextField.Description class={styles.description}>{local.description}</KTextField.Description>
      </Show>
      ...
      <Show when={local.errorMessage}>
        <KTextField.ErrorMessage class={styles.errorMessage}>{local.errorMessage}</KTextField.ErrorMessage>
      </Show>
    </KTextField.Root>
  );
}

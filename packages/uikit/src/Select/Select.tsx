...
interface SelectProps<T extends SelectItem = SelectItem> extends Omit<
  ComponentProps<"div">,
  "onChange"
> {
  options: T[];
  ...
  return (
    ...
    >
      ...
      <KSelect.Trigger class={styles.trigger}>
        ...
        <KSelect.Icon class={styles.icon}>{local.triggerIcon ?? <ChevronDownIcon />}</KSelect.Icon>
      </KSelect.Trigger>
      <KSelect.Portal>

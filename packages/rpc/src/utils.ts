...
export function isJsonRpcSubscription(value: unknown): value is JsonRpcSubscription<any> {
  return isJsonRpcObject(value) && 'method' in value && value.method === 'subscription' && 'params' in value;
}
...
export function isJsonRpcUnsubscribeRequest(value: unknown): value is JsonRpcSubscribeRequest {

...
function SpacingDemo() {
  ...
  return (
    <section className="bg-white rounded-[--radius-kda-foundation-lg] p-[--spacing-kda-foundation-lg] shadow-sm">
      <h2 className="text-lg font-semibold mb-[--spacing-kda-foundation-xs] text-gray-900">Spacing Tokens</h2>
      <p className="text-gray-600 mb-[--spacing-kda-foundation-lg] text-sm">
        Using <code className="bg-gray-100 px-1.5 py-0.5 rounded-[--radius-kda-foundation-xs] text-xs">p-[--spacing-kda-foundation-*]</code> for consistent spacing
      </p>

      <div className="flex flex-wrap gap-[--spacing-kda-foundation-md]">
        {spacings.map((s) => (
          <div key={s.name} className="flex flex-col items-center gap-[--spacing-kda-foundation-xs]">
            <div className={`${s.class} bg-gradient-to-br from-indigo-500 to-purple-600 rounded-[--radius-kda-foundation-xs] min-w-1 min-h-1`} />
      ...
      <h3 className="mt-[--spacing-kda-foundation-lg] mb-[--spacing-kda-foundation-md] text-gray-700 font-medium">Spacing in Action</h3>
      <div className="flex flex-wrap gap-[--spacing-kda-foundation-md]">
        <div className="p-[--spacing-kda-foundation-md] bg-gray-50 border border-gray-200 rounded-[--radius-kda-foundation-md] flex-1 min-w-36">
          <p className="text-xs m-0">Padding: <code className="text-[10px]">spacing-md</code></p>
        </div>
        <div className="p-[--spacing-kda-foundation-lg] bg-gray-50 border border-gray-200 rounded-[--radius-kda-foundation-md] flex-1 min-w-36">
          <p className="text-xs m-0">Padding: <code className="text-[10px]">spacing-lg</code></p>
        </div>
        <div className="p-[--spacing-kda-foundation-xl] bg-gray-50 border border-gray-200 rounded-[--radius-kda-foundation-md] flex-1 min-w-36">
          <p className="text-xs m-0">Padding: <code className="text-[10px]">spacing-xl</code></p>
        </div>
      </div>
    </section>
  );
...
function SizingDemo() {
  ...
  return (
    <section className="bg-white rounded-[--radius-kda-foundation-lg] p-[--spacing-kda-foundation-lg] shadow-sm">
      <h2 className="text-lg font-semibold mb-[--spacing-kda-foundation-xs] text-gray-900">Size Tokens</h2>
      <p className="text-gray-600 mb-[--spacing-kda-foundation-lg] text-sm">
        Using <code className="bg-gray-100 px-1.5 py-0.5 rounded-[--radius-kda-foundation-xs] text-xs">size-[--spacing-kda-foundation-size-*]</code> for consistent sizing
      </p>

      <div className="flex flex-wrap gap-[--spacing-kda-foundation-lg] items-end">
        {sizes.map((s) => (
          <div key={s.name} className="flex flex-col items-center gap-[--spacing-kda-foundation-xs]">
            <div className={`${s.class} bg-gradient-to-br from-teal-500 to-green-400 rounded-[--radius-kda-foundation-sm]`} />
            <span className="text-xs font-semibold">{s.name}</span>
          </div>
        ))}
      </div>

      <h3 className="mt-[--spacing-kda-foundation-lg] mb-[--spacing-kda-foundation-md] text-gray-700 font-medium">Icon Sizes</h3>
...
function RadiusDemo() {
  ...
  return (
    <section className="bg-white rounded-[--radius-kda-foundation-lg] p-[--spacing-kda-foundation-lg] shadow-sm">
      <h2 className="text-lg font-semibold mb-[--spacing-kda-foundation-xs] text-gray-900">Border Radius Tokens</h2>
      <p className="text-gray-600 mb-[--spacing-kda-foundation-lg] text-sm">
        Using <code className="bg-gray-100 px-1.5 py-0.5 rounded-[--radius-kda-foundation-xs] text-xs">rounded-[--radius-kda-foundation-*]</code> for consistent corners
      </p>

      <div className="flex flex-wrap gap-[--spacing-kda-foundation-lg]">
        {radii.map((r) => (
          <div key={r.name} className="flex flex-col items-center gap-[--spacing-kda-foundation-xs]">
      ...
      <h3 className="mt-[--spacing-kda-foundation-lg] mb-[--spacing-kda-foundation-md] text-gray-700 font-medium">Button Styles</h3>
      <div className="flex flex-wrap gap-[--spacing-kda-foundation-md]">
...
function TransitionsDemo() {
  ...
  return (
    <section className="bg-white rounded-[--radius-kda-foundation-lg] p-[--spacing-kda-foundation-lg] shadow-sm">
      <h2 className="text-lg font-semibold mb-[--spacing-kda-foundation-xs] text-gray-900">Transition Tokens</h2>
      <p className="text-gray-600 mb-[--spacing-kda-foundation-lg] text-sm">
        Using <code className="bg-gray-100 px-1.5 py-0.5 rounded-[--radius-kda-foundation-xs] text-xs">duration-[--duration-*]</code> for animations
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-[--spacing-kda-foundation-md]">
        {transitions.map((t) => (
          ...
          >
            ...
            <code className={`text-[10px] break-all ${hovered === t.id ? 'text-white/80' : 'text-gray-500'}`}>
              {t.class}
            </code>
          </div>
        ))}
      ...
      <h3 className="mt-[--spacing-kda-foundation-lg] mb-[--spacing-kda-foundation-md] text-gray-700 font-medium">Z-Index Demo</h3>
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans">
      <header className="bg-gradient-to-br from-indigo-500 to-purple-600 text-white py-[--spacing-kda-foundation-xl] px-[--spacing-kda-foundation-lg] text-center">
        <h1 className="text-2xl font-bold m-0 mb-[--spacing-kda-foundation-xs]">Tailwind CSS v4 Plugin Example</h1>
      ...
      <footer className="text-center p-[--spacing-kda-foundation-lg] text-gray-500 text-sm">
        <p>
          Tokens imported from <code className="bg-gray-100 px-1.5 py-0.5 rounded-[--radius-kda-foundation-xs]">./tokens/theme.css</code> via{' '}
          <code className="bg-gray-100 px-1.5 py-0.5 rounded-[--radius-kda-foundation-xs]">@theme</code>
        </p>
      </footer>
    </div>
  );

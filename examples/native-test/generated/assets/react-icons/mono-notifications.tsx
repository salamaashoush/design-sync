...
export interface MonoNotificationsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoNotificationsIcon = React.forwardRef<SVGSVGElement, MonoNotificationsIconProps>(
...
MonoNotificationsIcon.displayName = "MonoNotificationsIcon";

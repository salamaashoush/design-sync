...
export interface MonoThumbUpOffAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoThumbUpOffAltIcon = React.forwardRef<SVGSVGElement, MonoThumbUpOffAltIconProps>(
...
MonoThumbUpOffAltIcon.displayName = "MonoThumbUpOffAltIcon";

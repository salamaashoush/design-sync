...
export interface MonoAnimationIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAnimationIcon = React.forwardRef<SVGSVGElement, MonoAnimationIconProps>(
...
MonoAnimationIcon.displayName = "MonoAnimationIcon";

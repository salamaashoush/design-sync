...
export interface MonoAvTimerIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAvTimerIcon = React.forwardRef<SVGSVGElement, MonoAvTimerIconProps>(
...
MonoAvTimerIcon.displayName = "MonoAvTimerIcon";

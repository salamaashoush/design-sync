...
export interface MonoDepartureBoardIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDepartureBoardIcon = React.forwardRef<SVGSVGElement, MonoDepartureBoardIconProps>(
...
MonoDepartureBoardIcon.displayName = "MonoDepartureBoardIcon";

...
export interface MonoShoppingBagIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoShoppingBagIcon = React.forwardRef<SVGSVGElement, MonoShoppingBagIconProps>(
...
MonoShoppingBagIcon.displayName = "MonoShoppingBagIcon";

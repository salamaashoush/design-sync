...
export interface MonoIntegrationInstructionsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoIntegrationInstructionsIcon = React.forwardRef<SVGSVGElement, MonoIntegrationInstructionsIconProps>(
...
MonoIntegrationInstructionsIcon.displayName = "MonoIntegrationInstructionsIcon";

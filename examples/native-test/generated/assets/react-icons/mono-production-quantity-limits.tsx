...
export interface MonoProductionQuantityLimitsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoProductionQuantityLimitsIcon = React.forwardRef<SVGSVGElement, MonoProductionQuantityLimitsIconProps>(
...
MonoProductionQuantityLimitsIcon.displayName = "MonoProductionQuantityLimitsIcon";

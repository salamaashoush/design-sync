...
export interface MonoElectricalServicesIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoElectricalServicesIcon = React.forwardRef<SVGSVGElement, MonoElectricalServicesIconProps>(
...
MonoElectricalServicesIcon.displayName = "MonoElectricalServicesIcon";

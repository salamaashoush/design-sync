...
export interface MonoSyncLockIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSyncLockIcon = React.forwardRef<SVGSVGElement, MonoSyncLockIconProps>(
...
MonoSyncLockIcon.displayName = "MonoSyncLockIcon";

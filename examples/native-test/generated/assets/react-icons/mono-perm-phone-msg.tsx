...
export interface MonoPermPhoneMsgIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPermPhoneMsgIcon = React.forwardRef<SVGSVGElement, MonoPermPhoneMsgIconProps>(
...
MonoPermPhoneMsgIcon.displayName = "MonoPermPhoneMsgIcon";

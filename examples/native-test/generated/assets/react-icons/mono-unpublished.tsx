...
export interface MonoUnpublishedIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoUnpublishedIcon = React.forwardRef<SVGSVGElement, MonoUnpublishedIconProps>(
...
MonoUnpublishedIcon.displayName = "MonoUnpublishedIcon";

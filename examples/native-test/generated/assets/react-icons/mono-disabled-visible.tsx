...
export interface MonoDisabledVisibleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDisabledVisibleIcon = React.forwardRef<SVGSVGElement, MonoDisabledVisibleIconProps>(
...
MonoDisabledVisibleIcon.displayName = "MonoDisabledVisibleIcon";

...
export interface MonoWidthFullIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoWidthFullIcon = React.forwardRef<SVGSVGElement, MonoWidthFullIconProps>(
...
MonoWidthFullIcon.displayName = "MonoWidthFullIcon";

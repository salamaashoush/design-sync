...
export interface MonoDoDisturbIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDoDisturbIcon = React.forwardRef<SVGSVGElement, MonoDoDisturbIconProps>(
...
MonoDoDisturbIcon.displayName = "MonoDoDisturbIcon";

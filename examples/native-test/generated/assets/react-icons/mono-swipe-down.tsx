...
export interface MonoSwipeDownIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSwipeDownIcon = React.forwardRef<SVGSVGElement, MonoSwipeDownIconProps>(
...
MonoSwipeDownIcon.displayName = "MonoSwipeDownIcon";

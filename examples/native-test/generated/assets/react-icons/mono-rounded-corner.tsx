...
export interface MonoRoundedCornerIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRoundedCornerIcon = React.forwardRef<SVGSVGElement, MonoRoundedCornerIconProps>(
...
MonoRoundedCornerIcon.displayName = "MonoRoundedCornerIcon";

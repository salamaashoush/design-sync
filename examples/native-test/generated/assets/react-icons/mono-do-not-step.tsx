...
export interface MonoDoNotStepIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDoNotStepIcon = React.forwardRef<SVGSVGElement, MonoDoNotStepIconProps>(
...
MonoDoNotStepIcon.displayName = "MonoDoNotStepIcon";

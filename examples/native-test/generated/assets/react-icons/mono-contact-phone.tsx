...
export interface MonoContactPhoneIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoContactPhoneIcon = React.forwardRef<SVGSVGElement, MonoContactPhoneIconProps>(
...
MonoContactPhoneIcon.displayName = "MonoContactPhoneIcon";

...
export interface MonoSettingsApplicationsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSettingsApplicationsIcon = React.forwardRef<SVGSVGElement, MonoSettingsApplicationsIconProps>(
...
MonoSettingsApplicationsIcon.displayName = "MonoSettingsApplicationsIcon";

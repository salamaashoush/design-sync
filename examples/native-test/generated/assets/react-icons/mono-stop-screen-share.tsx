...
export interface MonoStopScreenShareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoStopScreenShareIcon = React.forwardRef<SVGSVGElement, MonoStopScreenShareIconProps>(
...
MonoStopScreenShareIcon.displayName = "MonoStopScreenShareIcon";

...
export interface MonoAllInclusiveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAllInclusiveIcon = React.forwardRef<SVGSVGElement, MonoAllInclusiveIconProps>(
...
MonoAllInclusiveIcon.displayName = "MonoAllInclusiveIcon";

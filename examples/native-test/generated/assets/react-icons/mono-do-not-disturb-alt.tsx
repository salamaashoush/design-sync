...
export interface MonoDoNotDisturbAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDoNotDisturbAltIcon = React.forwardRef<SVGSVGElement, MonoDoNotDisturbAltIconProps>(
...
MonoDoNotDisturbAltIcon.displayName = "MonoDoNotDisturbAltIcon";

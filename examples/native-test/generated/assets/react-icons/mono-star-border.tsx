...
export interface MonoStarBorderIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoStarBorderIcon = React.forwardRef<SVGSVGElement, MonoStarBorderIconProps>(
...
MonoStarBorderIcon.displayName = "MonoStarBorderIcon";

...
export interface MonoSubscriptionsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSubscriptionsIcon = React.forwardRef<SVGSVGElement, MonoSubscriptionsIconProps>(
...
MonoSubscriptionsIcon.displayName = "MonoSubscriptionsIcon";

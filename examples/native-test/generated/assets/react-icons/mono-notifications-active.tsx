...
export interface MonoNotificationsActiveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoNotificationsActiveIcon = React.forwardRef<SVGSVGElement, MonoNotificationsActiveIconProps>(
...
MonoNotificationsActiveIcon.displayName = "MonoNotificationsActiveIcon";

...
export interface MonoReduceCapacityIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoReduceCapacityIcon = React.forwardRef<SVGSVGElement, MonoReduceCapacityIconProps>(
...
MonoReduceCapacityIcon.displayName = "MonoReduceCapacityIcon";

...
export interface MonoWifiTetheringOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoWifiTetheringOffIcon = React.forwardRef<SVGSVGElement, MonoWifiTetheringOffIconProps>(
...
MonoWifiTetheringOffIcon.displayName = "MonoWifiTetheringOffIcon";

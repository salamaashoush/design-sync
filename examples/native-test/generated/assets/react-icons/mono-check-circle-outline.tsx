...
export interface MonoCheckCircleOutlineIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCheckCircleOutlineIcon = React.forwardRef<SVGSVGElement, MonoCheckCircleOutlineIconProps>(
...
MonoCheckCircleOutlineIcon.displayName = "MonoCheckCircleOutlineIcon";

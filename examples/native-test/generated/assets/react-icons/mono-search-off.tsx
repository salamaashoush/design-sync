...
export interface MonoSearchOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSearchOffIcon = React.forwardRef<SVGSVGElement, MonoSearchOffIconProps>(
...
MonoSearchOffIcon.displayName = "MonoSearchOffIcon";

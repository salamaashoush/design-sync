...
export interface MonoCloudOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCloudOffIcon = React.forwardRef<SVGSVGElement, MonoCloudOffIconProps>(
...
MonoCloudOffIcon.displayName = "MonoCloudOffIcon";

...
export interface MonoCallMergeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCallMergeIcon = React.forwardRef<SVGSVGElement, MonoCallMergeIconProps>(
...
MonoCallMergeIcon.displayName = "MonoCallMergeIcon";

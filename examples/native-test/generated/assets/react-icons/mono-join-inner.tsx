...
export interface MonoJoinInnerIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoJoinInnerIcon = React.forwardRef<SVGSVGElement, MonoJoinInnerIconProps>(
...
MonoJoinInnerIcon.displayName = "MonoJoinInnerIcon";

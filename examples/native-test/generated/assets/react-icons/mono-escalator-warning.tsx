...
export interface MonoEscalatorWarningIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoEscalatorWarningIcon = React.forwardRef<SVGSVGElement, MonoEscalatorWarningIconProps>(
...
MonoEscalatorWarningIcon.displayName = "MonoEscalatorWarningIcon";

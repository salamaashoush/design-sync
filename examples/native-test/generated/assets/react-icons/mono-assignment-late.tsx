...
export interface MonoAssignmentLateIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAssignmentLateIcon = React.forwardRef<SVGSVGElement, MonoAssignmentLateIconProps>(
...
MonoAssignmentLateIcon.displayName = "MonoAssignmentLateIcon";

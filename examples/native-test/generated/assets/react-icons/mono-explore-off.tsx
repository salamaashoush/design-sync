...
export interface MonoExploreOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoExploreOffIcon = React.forwardRef<SVGSVGElement, MonoExploreOffIconProps>(
...
MonoExploreOffIcon.displayName = "MonoExploreOffIcon";

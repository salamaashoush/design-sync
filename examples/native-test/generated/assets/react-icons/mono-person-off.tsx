...
export interface MonoPersonOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPersonOffIcon = React.forwardRef<SVGSVGElement, MonoPersonOffIconProps>(
...
MonoPersonOffIcon.displayName = "MonoPersonOffIcon";

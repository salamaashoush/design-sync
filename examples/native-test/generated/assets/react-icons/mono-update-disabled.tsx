...
export interface MonoUpdateDisabledIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoUpdateDisabledIcon = React.forwardRef<SVGSVGElement, MonoUpdateDisabledIconProps>(
...
MonoUpdateDisabledIcon.displayName = "MonoUpdateDisabledIcon";

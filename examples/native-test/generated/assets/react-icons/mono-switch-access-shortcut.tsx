...
export interface MonoSwitchAccessShortcutIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSwitchAccessShortcutIcon = React.forwardRef<SVGSVGElement, MonoSwitchAccessShortcutIconProps>(
...
MonoSwitchAccessShortcutIcon.displayName = "MonoSwitchAccessShortcutIcon";

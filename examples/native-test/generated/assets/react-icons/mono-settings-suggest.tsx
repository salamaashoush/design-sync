...
export interface MonoSettingsSuggestIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSettingsSuggestIcon = React.forwardRef<SVGSVGElement, MonoSettingsSuggestIconProps>(
...
MonoSettingsSuggestIcon.displayName = "MonoSettingsSuggestIcon";

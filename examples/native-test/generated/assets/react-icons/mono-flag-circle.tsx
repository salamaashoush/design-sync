...
export interface MonoFlagCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFlagCircleIcon = React.forwardRef<SVGSVGElement, MonoFlagCircleIconProps>(
...
MonoFlagCircleIcon.displayName = "MonoFlagCircleIcon";

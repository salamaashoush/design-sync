...
export interface MonoAddAlarmIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAddAlarmIcon = React.forwardRef<SVGSVGElement, MonoAddAlarmIconProps>(
...
MonoAddAlarmIcon.displayName = "MonoAddAlarmIcon";

...
export interface MonoFace5IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFace5Icon = React.forwardRef<SVGSVGElement, MonoFace5IconProps>(
...
MonoFace5Icon.displayName = "MonoFace5Icon";

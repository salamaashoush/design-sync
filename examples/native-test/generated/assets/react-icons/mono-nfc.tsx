...
export interface MonoNfcIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoNfcIcon = React.forwardRef<SVGSVGElement, MonoNfcIconProps>(
...
MonoNfcIcon.displayName = "MonoNfcIcon";

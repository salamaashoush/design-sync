...
export interface MonoNotStartedIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoNotStartedIcon = React.forwardRef<SVGSVGElement, MonoNotStartedIconProps>(
...
MonoNotStartedIcon.displayName = "MonoNotStartedIcon";

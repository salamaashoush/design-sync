...
export interface MonoClosedCaptionIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoClosedCaptionIcon = React.forwardRef<SVGSVGElement, MonoClosedCaptionIconProps>(
...
MonoClosedCaptionIcon.displayName = "MonoClosedCaptionIcon";

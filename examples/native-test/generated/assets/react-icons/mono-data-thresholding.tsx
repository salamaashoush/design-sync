...
export interface MonoDataThresholdingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDataThresholdingIcon = React.forwardRef<SVGSVGElement, MonoDataThresholdingIconProps>(
...
MonoDataThresholdingIcon.displayName = "MonoDataThresholdingIcon";

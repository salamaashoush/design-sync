...
export interface MonoDirectionsSubwayIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDirectionsSubwayIcon = React.forwardRef<SVGSVGElement, MonoDirectionsSubwayIconProps>(
...
MonoDirectionsSubwayIcon.displayName = "MonoDirectionsSubwayIcon";

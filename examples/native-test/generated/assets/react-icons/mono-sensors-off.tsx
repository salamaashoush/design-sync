...
export interface MonoSensorsOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSensorsOffIcon = React.forwardRef<SVGSVGElement, MonoSensorsOffIconProps>(
...
MonoSensorsOffIcon.displayName = "MonoSensorsOffIcon";

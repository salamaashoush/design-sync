...
export interface MonoAlarmAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAlarmAddIcon = React.forwardRef<SVGSVGElement, MonoAlarmAddIconProps>(
...
MonoAlarmAddIcon.displayName = "MonoAlarmAddIcon";

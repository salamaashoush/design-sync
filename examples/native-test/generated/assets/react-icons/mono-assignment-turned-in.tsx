...
export interface MonoAssignmentTurnedInIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAssignmentTurnedInIcon = React.forwardRef<SVGSVGElement, MonoAssignmentTurnedInIconProps>(
...
MonoAssignmentTurnedInIcon.displayName = "MonoAssignmentTurnedInIcon";

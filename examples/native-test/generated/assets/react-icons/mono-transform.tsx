...
export interface MonoTransformIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoTransformIcon = React.forwardRef<SVGSVGElement, MonoTransformIconProps>(
...
MonoTransformIcon.displayName = "MonoTransformIcon";

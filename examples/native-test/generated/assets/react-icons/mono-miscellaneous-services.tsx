...
export interface MonoMiscellaneousServicesIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMiscellaneousServicesIcon = React.forwardRef<SVGSVGElement, MonoMiscellaneousServicesIconProps>(
...
MonoMiscellaneousServicesIcon.displayName = "MonoMiscellaneousServicesIcon";

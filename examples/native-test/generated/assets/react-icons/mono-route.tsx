...
export interface MonoRouteIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRouteIcon = React.forwardRef<SVGSVGElement, MonoRouteIconProps>(
...
MonoRouteIcon.displayName = "MonoRouteIcon";

...
export interface MonoDoNotDisturbIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDoNotDisturbIcon = React.forwardRef<SVGSVGElement, MonoDoNotDisturbIconProps>(
...
MonoDoNotDisturbIcon.displayName = "MonoDoNotDisturbIcon";

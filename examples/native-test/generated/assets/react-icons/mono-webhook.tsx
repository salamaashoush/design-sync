...
export interface MonoWebhookIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoWebhookIcon = React.forwardRef<SVGSVGElement, MonoWebhookIconProps>(
...
MonoWebhookIcon.displayName = "MonoWebhookIcon";

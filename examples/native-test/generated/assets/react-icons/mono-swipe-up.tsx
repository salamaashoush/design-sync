...
export interface MonoSwipeUpIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSwipeUpIcon = React.forwardRef<SVGSVGElement, MonoSwipeUpIconProps>(
...
MonoSwipeUpIcon.displayName = "MonoSwipeUpIcon";

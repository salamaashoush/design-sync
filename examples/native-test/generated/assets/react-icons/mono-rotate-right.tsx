...
export interface MonoRotateRightIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRotateRightIcon = React.forwardRef<SVGSVGElement, MonoRotateRightIconProps>(
...
MonoRotateRightIcon.displayName = "MonoRotateRightIcon";

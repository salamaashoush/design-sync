...
export interface MonoDatasetIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDatasetIcon = React.forwardRef<SVGSVGElement, MonoDatasetIconProps>(
...
MonoDatasetIcon.displayName = "MonoDatasetIcon";

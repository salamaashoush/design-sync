...
export interface MonoManageAccountsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoManageAccountsIcon = React.forwardRef<SVGSVGElement, MonoManageAccountsIconProps>(
...
MonoManageAccountsIcon.displayName = "MonoManageAccountsIcon";

...
export interface MonoChecklistIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoChecklistIcon = React.forwardRef<SVGSVGElement, MonoChecklistIconProps>(
...
MonoChecklistIcon.displayName = "MonoChecklistIcon";

...
export interface MonoHistoryToggleOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoHistoryToggleOffIcon = React.forwardRef<SVGSVGElement, MonoHistoryToggleOffIconProps>(
...
MonoHistoryToggleOffIcon.displayName = "MonoHistoryToggleOffIcon";

...
export interface MonoBrightness4IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoBrightness4Icon = React.forwardRef<SVGSVGElement, MonoBrightness4IconProps>(
...
MonoBrightness4Icon.displayName = "MonoBrightness4Icon";

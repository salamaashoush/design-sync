...
export interface MonoAddToQueueIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAddToQueueIcon = React.forwardRef<SVGSVGElement, MonoAddToQueueIconProps>(
...
MonoAddToQueueIcon.displayName = "MonoAddToQueueIcon";

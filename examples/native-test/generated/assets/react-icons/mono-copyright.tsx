...
export interface MonoCopyrightIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCopyrightIcon = React.forwardRef<SVGSVGElement, MonoCopyrightIconProps>(
...
MonoCopyrightIcon.displayName = "MonoCopyrightIcon";

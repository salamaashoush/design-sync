...
export interface MonoTouchAppIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoTouchAppIcon = React.forwardRef<SVGSVGElement, MonoTouchAppIconProps>(
...
MonoTouchAppIcon.displayName = "MonoTouchAppIcon";

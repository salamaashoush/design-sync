...
export interface MonoMotionPhotosPauseIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMotionPhotosPauseIcon = React.forwardRef<SVGSVGElement, MonoMotionPhotosPauseIconProps>(
...
MonoMotionPhotosPauseIcon.displayName = "MonoMotionPhotosPauseIcon";

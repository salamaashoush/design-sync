...
export interface MonoRestartAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRestartAltIcon = React.forwardRef<SVGSVGElement, MonoRestartAltIconProps>(
...
MonoRestartAltIcon.displayName = "MonoRestartAltIcon";

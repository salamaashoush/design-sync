...
export interface MonoDataUsageIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDataUsageIcon = React.forwardRef<SVGSVGElement, MonoDataUsageIconProps>(
...
MonoDataUsageIcon.displayName = "MonoDataUsageIcon";

...
export interface MonoCurrencyExchangeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCurrencyExchangeIcon = React.forwardRef<SVGSVGElement, MonoCurrencyExchangeIconProps>(
...
MonoCurrencyExchangeIcon.displayName = "MonoCurrencyExchangeIcon";

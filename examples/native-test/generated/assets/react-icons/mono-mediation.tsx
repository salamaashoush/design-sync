...
export interface MonoMediationIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMediationIcon = React.forwardRef<SVGSVGElement, MonoMediationIconProps>(
...
MonoMediationIcon.displayName = "MonoMediationIcon";

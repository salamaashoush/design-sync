...
export interface MonoAccessTimeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAccessTimeIcon = React.forwardRef<SVGSVGElement, MonoAccessTimeIconProps>(
...
MonoAccessTimeIcon.displayName = "MonoAccessTimeIcon";

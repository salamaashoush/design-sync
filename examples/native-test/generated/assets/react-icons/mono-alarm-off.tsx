...
export interface MonoAlarmOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAlarmOffIcon = React.forwardRef<SVGSVGElement, MonoAlarmOffIconProps>(
...
MonoAlarmOffIcon.displayName = "MonoAlarmOffIcon";

...
export interface MonoDirectionsCarFilledIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDirectionsCarFilledIcon = React.forwardRef<SVGSVGElement, MonoDirectionsCarFilledIconProps>(
...
MonoDirectionsCarFilledIcon.displayName = "MonoDirectionsCarFilledIcon";

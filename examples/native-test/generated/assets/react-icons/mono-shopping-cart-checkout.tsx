...
export interface MonoShoppingCartCheckoutIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoShoppingCartCheckoutIcon = React.forwardRef<SVGSVGElement, MonoShoppingCartCheckoutIconProps>(
...
MonoShoppingCartCheckoutIcon.displayName = "MonoShoppingCartCheckoutIcon";

...
export interface MonoAirlineSeatReclineExtraIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAirlineSeatReclineExtraIcon = React.forwardRef<SVGSVGElement, MonoAirlineSeatReclineExtraIconProps>(
...
MonoAirlineSeatReclineExtraIcon.displayName = "MonoAirlineSeatReclineExtraIcon";

...
export interface MonoRadarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRadarIcon = React.forwardRef<SVGSVGElement, MonoRadarIconProps>(
...
MonoRadarIcon.displayName = "MonoRadarIcon";

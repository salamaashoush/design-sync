...
export interface MonoFolderSharedIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFolderSharedIcon = React.forwardRef<SVGSVGElement, MonoFolderSharedIconProps>(
...
MonoFolderSharedIcon.displayName = "MonoFolderSharedIcon";

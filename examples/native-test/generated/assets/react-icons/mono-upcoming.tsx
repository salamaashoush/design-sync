...
export interface MonoUpcomingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoUpcomingIcon = React.forwardRef<SVGSVGElement, MonoUpcomingIconProps>(
...
MonoUpcomingIcon.displayName = "MonoUpcomingIcon";

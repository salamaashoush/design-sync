...
export interface MonoViewInArIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoViewInArIcon = React.forwardRef<SVGSVGElement, MonoViewInArIconProps>(
...
MonoViewInArIcon.displayName = "MonoViewInArIcon";

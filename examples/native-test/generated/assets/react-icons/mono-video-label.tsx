...
export interface MonoVideoLabelIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoVideoLabelIcon = React.forwardRef<SVGSVGElement, MonoVideoLabelIconProps>(
...
MonoVideoLabelIcon.displayName = "MonoVideoLabelIcon";

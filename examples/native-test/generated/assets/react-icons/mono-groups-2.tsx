...
export interface MonoGroups2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoGroups2Icon = React.forwardRef<SVGSVGElement, MonoGroups2IconProps>(
...
MonoGroups2Icon.displayName = "MonoGroups2Icon";

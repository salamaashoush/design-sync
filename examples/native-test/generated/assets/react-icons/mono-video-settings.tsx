...
export interface MonoVideoSettingsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoVideoSettingsIcon = React.forwardRef<SVGSVGElement, MonoVideoSettingsIconProps>(
...
MonoVideoSettingsIcon.displayName = "MonoVideoSettingsIcon";

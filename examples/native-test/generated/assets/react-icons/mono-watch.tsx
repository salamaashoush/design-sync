...
export interface MonoWatchIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoWatchIcon = React.forwardRef<SVGSVGElement, MonoWatchIconProps>(
...
MonoWatchIcon.displayName = "MonoWatchIcon";

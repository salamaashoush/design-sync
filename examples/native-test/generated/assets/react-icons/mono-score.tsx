...
export interface MonoScoreIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoScoreIcon = React.forwardRef<SVGSVGElement, MonoScoreIconProps>(
...
MonoScoreIcon.displayName = "MonoScoreIcon";

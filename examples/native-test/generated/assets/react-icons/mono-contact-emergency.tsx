...
export interface MonoContactEmergencyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoContactEmergencyIcon = React.forwardRef<SVGSVGElement, MonoContactEmergencyIconProps>(
...
MonoContactEmergencyIcon.displayName = "MonoContactEmergencyIcon";

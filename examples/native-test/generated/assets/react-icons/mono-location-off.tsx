...
export interface MonoLocationOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoLocationOffIcon = React.forwardRef<SVGSVGElement, MonoLocationOffIconProps>(
...
MonoLocationOffIcon.displayName = "MonoLocationOffIcon";

...
export interface MonoPortableWifiOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPortableWifiOffIcon = React.forwardRef<SVGSVGElement, MonoPortableWifiOffIconProps>(
...
MonoPortableWifiOffIcon.displayName = "MonoPortableWifiOffIcon";

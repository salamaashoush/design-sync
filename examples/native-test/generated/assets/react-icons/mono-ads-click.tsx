...
export interface MonoAdsClickIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAdsClickIcon = React.forwardRef<SVGSVGElement, MonoAdsClickIconProps>(
...
MonoAdsClickIcon.displayName = "MonoAdsClickIcon";

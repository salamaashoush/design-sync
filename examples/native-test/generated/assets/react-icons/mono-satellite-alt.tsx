...
export interface MonoSatelliteAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSatelliteAltIcon = React.forwardRef<SVGSVGElement, MonoSatelliteAltIconProps>(
...
MonoSatelliteAltIcon.displayName = "MonoSatelliteAltIcon";

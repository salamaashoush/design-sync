...
export interface MonoLinkOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoLinkOffIcon = React.forwardRef<SVGSVGElement, MonoLinkOffIconProps>(
...
MonoLinkOffIcon.displayName = "MonoLinkOffIcon";

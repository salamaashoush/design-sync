...
export interface MonoDoDisturbAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDoDisturbAltIcon = React.forwardRef<SVGSVGElement, MonoDoDisturbAltIconProps>(
...
MonoDoDisturbAltIcon.displayName = "MonoDoDisturbAltIcon";

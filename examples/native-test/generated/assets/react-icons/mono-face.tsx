...
export interface MonoFaceIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFaceIcon = React.forwardRef<SVGSVGElement, MonoFaceIconProps>(
...
MonoFaceIcon.displayName = "MonoFaceIcon";

...
export interface MonoQueryBuilderIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoQueryBuilderIcon = React.forwardRef<SVGSVGElement, MonoQueryBuilderIconProps>(
...
MonoQueryBuilderIcon.displayName = "MonoQueryBuilderIcon";

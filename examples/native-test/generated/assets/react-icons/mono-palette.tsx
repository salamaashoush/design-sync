...
export interface MonoPaletteIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPaletteIcon = React.forwardRef<SVGSVGElement, MonoPaletteIconProps>(
...
MonoPaletteIcon.displayName = "MonoPaletteIcon";

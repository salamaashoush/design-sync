...
export interface MonoContactlessIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoContactlessIcon = React.forwardRef<SVGSVGElement, MonoContactlessIconProps>(
...
MonoContactlessIcon.displayName = "MonoContactlessIcon";

...
export interface MonoVideoFileIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoVideoFileIcon = React.forwardRef<SVGSVGElement, MonoVideoFileIconProps>(
...
MonoVideoFileIcon.displayName = "MonoVideoFileIcon";

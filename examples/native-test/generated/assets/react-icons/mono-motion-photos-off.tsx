...
export interface MonoMotionPhotosOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMotionPhotosOffIcon = React.forwardRef<SVGSVGElement, MonoMotionPhotosOffIconProps>(
...
MonoMotionPhotosOffIcon.displayName = "MonoMotionPhotosOffIcon";

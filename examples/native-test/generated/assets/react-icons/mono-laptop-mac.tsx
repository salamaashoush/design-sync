...
export interface MonoLaptopMacIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoLaptopMacIcon = React.forwardRef<SVGSVGElement, MonoLaptopMacIconProps>(
...
MonoLaptopMacIcon.displayName = "MonoLaptopMacIcon";

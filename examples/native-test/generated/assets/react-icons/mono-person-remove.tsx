...
export interface MonoPersonRemoveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPersonRemoveIcon = React.forwardRef<SVGSVGElement, MonoPersonRemoveIconProps>(
...
MonoPersonRemoveIcon.displayName = "MonoPersonRemoveIcon";

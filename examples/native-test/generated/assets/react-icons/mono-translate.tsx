...
export interface MonoTranslateIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoTranslateIcon = React.forwardRef<SVGSVGElement, MonoTranslateIconProps>(
...
MonoTranslateIcon.displayName = "MonoTranslateIcon";

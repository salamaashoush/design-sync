...
export interface MonoTryIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoTryIcon = React.forwardRef<SVGSVGElement, MonoTryIconProps>(
...
MonoTryIcon.displayName = "MonoTryIcon";

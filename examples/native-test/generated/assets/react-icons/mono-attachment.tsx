...
export interface MonoAttachmentIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAttachmentIcon = React.forwardRef<SVGSVGElement, MonoAttachmentIconProps>(
...
MonoAttachmentIcon.displayName = "MonoAttachmentIcon";

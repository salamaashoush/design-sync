...
export interface MonoCableIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCableIcon = React.forwardRef<SVGSVGElement, MonoCableIconProps>(
...
MonoCableIcon.displayName = "MonoCableIcon";

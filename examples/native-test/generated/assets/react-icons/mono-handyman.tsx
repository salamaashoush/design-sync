...
export interface MonoHandymanIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoHandymanIcon = React.forwardRef<SVGSVGElement, MonoHandymanIconProps>(
...
MonoHandymanIcon.displayName = "MonoHandymanIcon";

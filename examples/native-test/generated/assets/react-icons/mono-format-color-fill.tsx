...
export interface MonoFormatColorFillIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFormatColorFillIcon = React.forwardRef<SVGSVGElement, MonoFormatColorFillIconProps>(
...
MonoFormatColorFillIcon.displayName = "MonoFormatColorFillIcon";

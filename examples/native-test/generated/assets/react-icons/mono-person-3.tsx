...
export interface MonoPerson3IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPerson3Icon = React.forwardRef<SVGSVGElement, MonoPerson3IconProps>(
...
MonoPerson3Icon.displayName = "MonoPerson3Icon";

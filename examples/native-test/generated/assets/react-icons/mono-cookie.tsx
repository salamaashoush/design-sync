...
export interface MonoCookieIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCookieIcon = React.forwardRef<SVGSVGElement, MonoCookieIconProps>(
...
MonoCookieIcon.displayName = "MonoCookieIcon";

...
export interface MonoPeopleAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPeopleAltIcon = React.forwardRef<SVGSVGElement, MonoPeopleAltIconProps>(
...
MonoPeopleAltIcon.displayName = "MonoPeopleAltIcon";

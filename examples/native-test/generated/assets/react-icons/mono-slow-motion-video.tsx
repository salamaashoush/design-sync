...
export interface MonoSlowMotionVideoIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSlowMotionVideoIcon = React.forwardRef<SVGSVGElement, MonoSlowMotionVideoIconProps>(
...
MonoSlowMotionVideoIcon.displayName = "MonoSlowMotionVideoIcon";

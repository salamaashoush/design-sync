...
export interface MonoSdStorageIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSdStorageIcon = React.forwardRef<SVGSVGElement, MonoSdStorageIconProps>(
...
MonoSdStorageIcon.displayName = "MonoSdStorageIcon";

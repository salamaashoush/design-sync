...
export interface MonoFlipCameraAndroidIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFlipCameraAndroidIcon = React.forwardRef<SVGSVGElement, MonoFlipCameraAndroidIconProps>(
...
MonoFlipCameraAndroidIcon.displayName = "MonoFlipCameraAndroidIcon";

...
export interface MonoDataSaverOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDataSaverOffIcon = React.forwardRef<SVGSVGElement, MonoDataSaverOffIconProps>(
...
MonoDataSaverOffIcon.displayName = "MonoDataSaverOffIcon";

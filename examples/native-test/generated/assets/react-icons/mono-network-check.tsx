...
export interface MonoNetworkCheckIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoNetworkCheckIcon = React.forwardRef<SVGSVGElement, MonoNetworkCheckIconProps>(
...
MonoNetworkCheckIcon.displayName = "MonoNetworkCheckIcon";

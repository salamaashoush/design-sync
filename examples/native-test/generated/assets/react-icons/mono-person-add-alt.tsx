...
export interface MonoPersonAddAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPersonAddAltIcon = React.forwardRef<SVGSVGElement, MonoPersonAddAltIconProps>(
...
MonoPersonAddAltIcon.displayName = "MonoPersonAddAltIcon";

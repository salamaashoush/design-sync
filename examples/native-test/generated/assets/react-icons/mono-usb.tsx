...
export interface MonoUsbIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoUsbIcon = React.forwardRef<SVGSVGElement, MonoUsbIconProps>(
...
MonoUsbIcon.displayName = "MonoUsbIcon";

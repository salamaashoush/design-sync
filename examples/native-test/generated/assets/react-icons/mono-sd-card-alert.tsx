...
export interface MonoSdCardAlertIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSdCardAlertIcon = React.forwardRef<SVGSVGElement, MonoSdCardAlertIconProps>(
...
MonoSdCardAlertIcon.displayName = "MonoSdCardAlertIcon";

...
export interface MonoLocalGasStationIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoLocalGasStationIcon = React.forwardRef<SVGSVGElement, MonoLocalGasStationIconProps>(
...
MonoLocalGasStationIcon.displayName = "MonoLocalGasStationIcon";

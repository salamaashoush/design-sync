...
export interface MonoColorizeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoColorizeIcon = React.forwardRef<SVGSVGElement, MonoColorizeIconProps>(
...
MonoColorizeIcon.displayName = "MonoColorizeIcon";

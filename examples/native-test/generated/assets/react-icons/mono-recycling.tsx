...
export interface MonoRecyclingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRecyclingIcon = React.forwardRef<SVGSVGElement, MonoRecyclingIconProps>(
...
MonoRecyclingIcon.displayName = "MonoRecyclingIcon";

...
export interface MonoScreenSearchDesktopIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoScreenSearchDesktopIcon = React.forwardRef<SVGSVGElement, MonoScreenSearchDesktopIconProps>(
...
MonoScreenSearchDesktopIcon.displayName = "MonoScreenSearchDesktopIcon";

...
export interface MonoEventNoteIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoEventNoteIcon = React.forwardRef<SVGSVGElement, MonoEventNoteIconProps>(
...
MonoEventNoteIcon.displayName = "MonoEventNoteIcon";

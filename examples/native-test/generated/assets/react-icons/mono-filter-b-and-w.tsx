...
export interface MonoFilterBAndWIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFilterBAndWIcon = React.forwardRef<SVGSVGElement, MonoFilterBAndWIconProps>(
...
MonoFilterBAndWIcon.displayName = "MonoFilterBAndWIcon";

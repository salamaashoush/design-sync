...
export interface MonoContentPasteSearchIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoContentPasteSearchIcon = React.forwardRef<SVGSVGElement, MonoContentPasteSearchIconProps>(
...
MonoContentPasteSearchIcon.displayName = "MonoContentPasteSearchIcon";

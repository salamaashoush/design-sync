...
export interface MonoDirectionsTransitIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDirectionsTransitIcon = React.forwardRef<SVGSVGElement, MonoDirectionsTransitIconProps>(
...
MonoDirectionsTransitIcon.displayName = "MonoDirectionsTransitIcon";

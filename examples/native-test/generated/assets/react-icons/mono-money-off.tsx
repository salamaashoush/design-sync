...
export interface MonoMoneyOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMoneyOffIcon = React.forwardRef<SVGSVGElement, MonoMoneyOffIconProps>(
...
MonoMoneyOffIcon.displayName = "MonoMoneyOffIcon";

...
export interface MonoThermostatAutoIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoThermostatAutoIcon = React.forwardRef<SVGSVGElement, MonoThermostatAutoIconProps>(
...
MonoThermostatAutoIcon.displayName = "MonoThermostatAutoIcon";

...
export interface MonoEuroSymbolIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoEuroSymbolIcon = React.forwardRef<SVGSVGElement, MonoEuroSymbolIconProps>(
...
MonoEuroSymbolIcon.displayName = "MonoEuroSymbolIcon";

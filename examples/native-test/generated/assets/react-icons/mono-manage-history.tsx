...
export interface MonoManageHistoryIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoManageHistoryIcon = React.forwardRef<SVGSVGElement, MonoManageHistoryIconProps>(
...
MonoManageHistoryIcon.displayName = "MonoManageHistoryIcon";

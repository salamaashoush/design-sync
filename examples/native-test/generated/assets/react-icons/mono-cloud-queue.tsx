...
export interface MonoCloudQueueIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCloudQueueIcon = React.forwardRef<SVGSVGElement, MonoCloudQueueIconProps>(
...
MonoCloudQueueIcon.displayName = "MonoCloudQueueIcon";

...
export interface MonoSupportIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSupportIcon = React.forwardRef<SVGSVGElement, MonoSupportIconProps>(
...
MonoSupportIcon.displayName = "MonoSupportIcon";

...
export interface MonoPermIdentityIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPermIdentityIcon = React.forwardRef<SVGSVGElement, MonoPermIdentityIconProps>(
...
MonoPermIdentityIcon.displayName = "MonoPermIdentityIcon";

...
export interface MonoMenuBookIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMenuBookIcon = React.forwardRef<SVGSVGElement, MonoMenuBookIconProps>(
...
MonoMenuBookIcon.displayName = "MonoMenuBookIcon";

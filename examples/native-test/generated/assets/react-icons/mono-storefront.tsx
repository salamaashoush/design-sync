...
export interface MonoStorefrontIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoStorefrontIcon = React.forwardRef<SVGSVGElement, MonoStorefrontIconProps>(
...
MonoStorefrontIcon.displayName = "MonoStorefrontIcon";

...
export interface MonoViewCompactAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoViewCompactAltIcon = React.forwardRef<SVGSVGElement, MonoViewCompactAltIconProps>(
...
MonoViewCompactAltIcon.displayName = "MonoViewCompactAltIcon";

...
export interface MonoPercentIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPercentIcon = React.forwardRef<SVGSVGElement, MonoPercentIconProps>(
...
MonoPercentIcon.displayName = "MonoPercentIcon";

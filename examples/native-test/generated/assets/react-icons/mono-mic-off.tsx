...
export interface MonoMicOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMicOffIcon = React.forwardRef<SVGSVGElement, MonoMicOffIconProps>(
...
MonoMicOffIcon.displayName = "MonoMicOffIcon";

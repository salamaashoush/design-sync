...
export interface MonoSimCardIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSimCardIcon = React.forwardRef<SVGSVGElement, MonoSimCardIconProps>(
...
MonoSimCardIcon.displayName = "MonoSimCardIcon";

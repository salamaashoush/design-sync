...
export interface MonoPaidIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPaidIcon = React.forwardRef<SVGSVGElement, MonoPaidIconProps>(
...
MonoPaidIcon.displayName = "MonoPaidIcon";

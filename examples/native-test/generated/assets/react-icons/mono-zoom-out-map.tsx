...
export interface MonoZoomOutMapIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoZoomOutMapIcon = React.forwardRef<SVGSVGElement, MonoZoomOutMapIconProps>(
...
MonoZoomOutMapIcon.displayName = "MonoZoomOutMapIcon";

...
export interface MonoRecommendIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRecommendIcon = React.forwardRef<SVGSVGElement, MonoRecommendIconProps>(
...
MonoRecommendIcon.displayName = "MonoRecommendIcon";

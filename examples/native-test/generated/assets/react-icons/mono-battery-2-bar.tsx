...
export interface MonoBattery2BarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoBattery2BarIcon = React.forwardRef<SVGSVGElement, MonoBattery2BarIconProps>(
...
MonoBattery2BarIcon.displayName = "MonoBattery2BarIcon";

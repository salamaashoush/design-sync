...
export interface MonoPermContactCalendarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPermContactCalendarIcon = React.forwardRef<SVGSVGElement, MonoPermContactCalendarIconProps>(
...
MonoPermContactCalendarIcon.displayName = "MonoPermContactCalendarIcon";

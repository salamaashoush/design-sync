...
export interface MonoCloudDownloadIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCloudDownloadIcon = React.forwardRef<SVGSVGElement, MonoCloudDownloadIconProps>(
...
MonoCloudDownloadIcon.displayName = "MonoCloudDownloadIcon";

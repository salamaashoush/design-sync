...
export interface MonoLogoGithubIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoLogoGithubIcon = React.forwardRef<SVGSVGElement, MonoLogoGithubIconProps>(
...
MonoLogoGithubIcon.displayName = "MonoLogoGithubIcon";

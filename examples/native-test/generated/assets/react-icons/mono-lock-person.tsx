...
export interface MonoLockPersonIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoLockPersonIcon = React.forwardRef<SVGSVGElement, MonoLockPersonIconProps>(
...
MonoLockPersonIcon.displayName = "MonoLockPersonIcon";

...
export interface MonoThermostatIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoThermostatIcon = React.forwardRef<SVGSVGElement, MonoThermostatIconProps>(
...
MonoThermostatIcon.displayName = "MonoThermostatIcon";

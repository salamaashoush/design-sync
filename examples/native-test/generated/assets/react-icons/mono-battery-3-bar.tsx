...
export interface MonoBattery3BarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoBattery3BarIcon = React.forwardRef<SVGSVGElement, MonoBattery3BarIconProps>(
...
MonoBattery3BarIcon.displayName = "MonoBattery3BarIcon";

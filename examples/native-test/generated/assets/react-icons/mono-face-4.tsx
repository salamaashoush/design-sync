...
export interface MonoFace4IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFace4Icon = React.forwardRef<SVGSVGElement, MonoFace4IconProps>(
...
MonoFace4Icon.displayName = "MonoFace4Icon";

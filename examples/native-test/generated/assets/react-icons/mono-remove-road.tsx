...
export interface MonoRemoveRoadIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRemoveRoadIcon = React.forwardRef<SVGSVGElement, MonoRemoveRoadIconProps>(
...
MonoRemoveRoadIcon.displayName = "MonoRemoveRoadIcon";

...
export interface MonoTextureIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoTextureIcon = React.forwardRef<SVGSVGElement, MonoTextureIconProps>(
...
MonoTextureIcon.displayName = "MonoTextureIcon";

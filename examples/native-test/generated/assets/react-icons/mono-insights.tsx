...
export interface MonoInsightsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoInsightsIcon = React.forwardRef<SVGSVGElement, MonoInsightsIconProps>(
...
MonoInsightsIcon.displayName = "MonoInsightsIcon";

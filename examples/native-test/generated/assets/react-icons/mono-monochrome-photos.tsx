...
export interface MonoMonochromePhotosIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMonochromePhotosIcon = React.forwardRef<SVGSVGElement, MonoMonochromePhotosIconProps>(
...
MonoMonochromePhotosIcon.displayName = "MonoMonochromePhotosIcon";

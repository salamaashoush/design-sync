...
export interface MonoGestureIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoGestureIcon = React.forwardRef<SVGSVGElement, MonoGestureIconProps>(
...
MonoGestureIcon.displayName = "MonoGestureIcon";

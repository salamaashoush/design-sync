...
export interface MonoAddIcCallIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAddIcCallIcon = React.forwardRef<SVGSVGElement, MonoAddIcCallIconProps>(
...
MonoAddIcCallIcon.displayName = "MonoAddIcCallIcon";

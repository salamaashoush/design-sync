...
export interface MonoGridOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoGridOffIcon = React.forwardRef<SVGSVGElement, MonoGridOffIconProps>(
...
MonoGridOffIcon.displayName = "MonoGridOffIcon";

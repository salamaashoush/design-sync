...
export interface MonoKeyboardCommandKeyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoKeyboardCommandKeyIcon = React.forwardRef<SVGSVGElement, MonoKeyboardCommandKeyIconProps>(
...
MonoKeyboardCommandKeyIcon.displayName = "MonoKeyboardCommandKeyIcon";

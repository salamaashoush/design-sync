...
export interface MonoAutoStoriesIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAutoStoriesIcon = React.forwardRef<SVGSVGElement, MonoAutoStoriesIconProps>(
...
MonoAutoStoriesIcon.displayName = "MonoAutoStoriesIcon";

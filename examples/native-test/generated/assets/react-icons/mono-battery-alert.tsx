...
export interface MonoBatteryAlertIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoBatteryAlertIcon = React.forwardRef<SVGSVGElement, MonoBatteryAlertIconProps>(
...
MonoBatteryAlertIcon.displayName = "MonoBatteryAlertIcon";

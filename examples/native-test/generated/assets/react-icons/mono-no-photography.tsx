...
export interface MonoNoPhotographyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoNoPhotographyIcon = React.forwardRef<SVGSVGElement, MonoNoPhotographyIconProps>(
...
MonoNoPhotographyIcon.displayName = "MonoNoPhotographyIcon";

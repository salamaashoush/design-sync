...
export interface MonoMoodBadIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMoodBadIcon = React.forwardRef<SVGSVGElement, MonoMoodBadIconProps>(
...
MonoMoodBadIcon.displayName = "MonoMoodBadIcon";

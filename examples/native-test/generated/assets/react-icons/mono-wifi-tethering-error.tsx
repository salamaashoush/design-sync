...
export interface MonoWifiTetheringErrorIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoWifiTetheringErrorIcon = React.forwardRef<SVGSVGElement, MonoWifiTetheringErrorIconProps>(
...
MonoWifiTetheringErrorIcon.displayName = "MonoWifiTetheringErrorIcon";

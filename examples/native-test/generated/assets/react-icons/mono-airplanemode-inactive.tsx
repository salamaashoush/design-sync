...
export interface MonoAirplanemodeInactiveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAirplanemodeInactiveIcon = React.forwardRef<SVGSVGElement, MonoAirplanemodeInactiveIconProps>(
...
MonoAirplanemodeInactiveIcon.displayName = "MonoAirplanemodeInactiveIcon";

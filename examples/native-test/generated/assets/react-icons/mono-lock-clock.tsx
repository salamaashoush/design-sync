...
export interface MonoLockClockIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoLockClockIcon = React.forwardRef<SVGSVGElement, MonoLockClockIconProps>(
...
MonoLockClockIcon.displayName = "MonoLockClockIcon";

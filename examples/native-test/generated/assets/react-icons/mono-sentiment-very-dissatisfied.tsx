...
export interface MonoSentimentVeryDissatisfiedIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSentimentVeryDissatisfiedIcon = React.forwardRef<SVGSVGElement, MonoSentimentVeryDissatisfiedIconProps>(
...
MonoSentimentVeryDissatisfiedIcon.displayName = "MonoSentimentVeryDissatisfiedIcon";

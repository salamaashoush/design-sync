...
export interface MonoTaskIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoTaskIcon = React.forwardRef<SVGSVGElement, MonoTaskIconProps>(
...
MonoTaskIcon.displayName = "MonoTaskIcon";

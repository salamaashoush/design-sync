...
export interface MonoZoomInIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoZoomInIcon = React.forwardRef<SVGSVGElement, MonoZoomInIconProps>(
...
MonoZoomInIcon.displayName = "MonoZoomInIcon";

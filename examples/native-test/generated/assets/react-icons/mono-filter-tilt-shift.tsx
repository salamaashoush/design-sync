...
export interface MonoFilterTiltShiftIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFilterTiltShiftIcon = React.forwardRef<SVGSVGElement, MonoFilterTiltShiftIconProps>(
...
MonoFilterTiltShiftIcon.displayName = "MonoFilterTiltShiftIcon";

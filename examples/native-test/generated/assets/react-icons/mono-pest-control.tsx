...
export interface MonoPestControlIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPestControlIcon = React.forwardRef<SVGSVGElement, MonoPestControlIconProps>(
...
MonoPestControlIcon.displayName = "MonoPestControlIcon";

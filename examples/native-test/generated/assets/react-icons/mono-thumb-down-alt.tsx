...
export interface MonoThumbDownAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoThumbDownAltIcon = React.forwardRef<SVGSVGElement, MonoThumbDownAltIconProps>(
...
MonoThumbDownAltIcon.displayName = "MonoThumbDownAltIcon";

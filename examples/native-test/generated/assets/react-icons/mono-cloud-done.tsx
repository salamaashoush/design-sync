...
export interface MonoCloudDoneIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCloudDoneIcon = React.forwardRef<SVGSVGElement, MonoCloudDoneIconProps>(
...
MonoCloudDoneIcon.displayName = "MonoCloudDoneIcon";

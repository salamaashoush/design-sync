...
export interface MonoRestorePageIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRestorePageIcon = React.forwardRef<SVGSVGElement, MonoRestorePageIconProps>(
...
MonoRestorePageIcon.displayName = "MonoRestorePageIcon";

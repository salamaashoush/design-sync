...
export interface MonoCameraAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoCameraAltIcon = React.forwardRef<SVGSVGElement, MonoCameraAltIconProps>(
...
MonoCameraAltIcon.displayName = "MonoCameraAltIcon";

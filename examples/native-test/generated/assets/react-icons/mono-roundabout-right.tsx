...
export interface MonoRoundaboutRightIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRoundaboutRightIcon = React.forwardRef<SVGSVGElement, MonoRoundaboutRightIconProps>(
...
MonoRoundaboutRightIcon.displayName = "MonoRoundaboutRightIcon";

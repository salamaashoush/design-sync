...
export interface MonoMoveUpIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMoveUpIcon = React.forwardRef<SVGSVGElement, MonoMoveUpIconProps>(
...
MonoMoveUpIcon.displayName = "MonoMoveUpIcon";

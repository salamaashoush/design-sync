...
export interface MonoMicNoneIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMicNoneIcon = React.forwardRef<SVGSVGElement, MonoMicNoneIconProps>(
...
MonoMicNoneIcon.displayName = "MonoMicNoneIcon";

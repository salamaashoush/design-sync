...
export interface MonoJoinLeftIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoJoinLeftIcon = React.forwardRef<SVGSVGElement, MonoJoinLeftIconProps>(
...
MonoJoinLeftIcon.displayName = "MonoJoinLeftIcon";

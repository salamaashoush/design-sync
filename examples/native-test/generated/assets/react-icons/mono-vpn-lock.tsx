...
export interface MonoVpnLockIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoVpnLockIcon = React.forwardRef<SVGSVGElement, MonoVpnLockIconProps>(
...
MonoVpnLockIcon.displayName = "MonoVpnLockIcon";

...
export interface MonoPinInvokeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPinInvokeIcon = React.forwardRef<SVGSVGElement, MonoPinInvokeIconProps>(
...
MonoPinInvokeIcon.displayName = "MonoPinInvokeIcon";

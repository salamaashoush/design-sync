...
export interface MonoSwipeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSwipeIcon = React.forwardRef<SVGSVGElement, MonoSwipeIconProps>(
...
MonoSwipeIcon.displayName = "MonoSwipeIcon";

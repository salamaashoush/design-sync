...
export interface MonoGroups3IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoGroups3Icon = React.forwardRef<SVGSVGElement, MonoGroups3IconProps>(
...
MonoGroups3Icon.displayName = "MonoGroups3Icon";

...
export interface MonoExtensionIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoExtensionIcon = React.forwardRef<SVGSVGElement, MonoExtensionIconProps>(
...
MonoExtensionIcon.displayName = "MonoExtensionIcon";

...
export interface MonoWAccountIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoWAccountIcon = React.forwardRef<SVGSVGElement, MonoWAccountIconProps>(

...
export interface MonoScoreboardIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoScoreboardIcon = React.forwardRef<SVGSVGElement, MonoScoreboardIconProps>(
...
MonoScoreboardIcon.displayName = "MonoScoreboardIcon";

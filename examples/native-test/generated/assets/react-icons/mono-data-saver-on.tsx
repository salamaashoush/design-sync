...
export interface MonoDataSaverOnIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDataSaverOnIcon = React.forwardRef<SVGSVGElement, MonoDataSaverOnIconProps>(
...
MonoDataSaverOnIcon.displayName = "MonoDataSaverOnIcon";

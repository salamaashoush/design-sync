...
export interface MonoFileCopyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFileCopyIcon = React.forwardRef<SVGSVGElement, MonoFileCopyIconProps>(
...
MonoFileCopyIcon.displayName = "MonoFileCopyIcon";

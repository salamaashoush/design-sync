...
export interface MonoBluetoothIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoBluetoothIcon = React.forwardRef<SVGSVGElement, MonoBluetoothIconProps>(
...
MonoBluetoothIcon.displayName = "MonoBluetoothIcon";

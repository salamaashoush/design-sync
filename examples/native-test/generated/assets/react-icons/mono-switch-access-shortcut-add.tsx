...
export interface MonoSwitchAccessShortcutAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSwitchAccessShortcutAddIcon = React.forwardRef<SVGSVGElement, MonoSwitchAccessShortcutAddIconProps>(
...
MonoSwitchAccessShortcutAddIcon.displayName = "MonoSwitchAccessShortcutAddIcon";

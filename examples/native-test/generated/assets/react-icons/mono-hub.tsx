...
export interface MonoHubIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoHubIcon = React.forwardRef<SVGSVGElement, MonoHubIconProps>(
...
MonoHubIcon.displayName = "MonoHubIcon";

...
export interface MonoRemoveFromQueueIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRemoveFromQueueIcon = React.forwardRef<SVGSVGElement, MonoRemoveFromQueueIconProps>(
...
MonoRemoveFromQueueIcon.displayName = "MonoRemoveFromQueueIcon";

...
export interface MonoMotionPhotosOnIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMotionPhotosOnIcon = React.forwardRef<SVGSVGElement, MonoMotionPhotosOnIconProps>(
...
MonoMotionPhotosOnIcon.displayName = "MonoMotionPhotosOnIcon";

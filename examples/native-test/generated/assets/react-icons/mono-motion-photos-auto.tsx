...
export interface MonoMotionPhotosAutoIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoMotionPhotosAutoIcon = React.forwardRef<SVGSVGElement, MonoMotionPhotosAutoIconProps>(
...
MonoMotionPhotosAutoIcon.displayName = "MonoMotionPhotosAutoIcon";

...
export interface MonoRotate90DegreesCcwIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRotate90DegreesCcwIcon = React.forwardRef<SVGSVGElement, MonoRotate90DegreesCcwIconProps>(
...
MonoRotate90DegreesCcwIcon.displayName = "MonoRotate90DegreesCcwIcon";

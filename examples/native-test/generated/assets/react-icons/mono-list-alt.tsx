...
export interface MonoListAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoListAltIcon = React.forwardRef<SVGSVGElement, MonoListAltIconProps>(
...
MonoListAltIcon.displayName = "MonoListAltIcon";

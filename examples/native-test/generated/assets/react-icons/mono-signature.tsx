...
export interface MonoSignatureIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSignatureIcon = React.forwardRef<SVGSVGElement, MonoSignatureIconProps>(

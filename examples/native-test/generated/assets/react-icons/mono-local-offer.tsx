...
export interface MonoLocalOfferIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoLocalOfferIcon = React.forwardRef<SVGSVGElement, MonoLocalOfferIconProps>(
...
MonoLocalOfferIcon.displayName = "MonoLocalOfferIcon";

...
export interface MonoBattery5BarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoBattery5BarIcon = React.forwardRef<SVGSVGElement, MonoBattery5BarIconProps>(
...
MonoBattery5BarIcon.displayName = "MonoBattery5BarIcon";

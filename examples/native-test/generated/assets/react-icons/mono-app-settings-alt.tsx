...
export interface MonoAppSettingsAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAppSettingsAltIcon = React.forwardRef<SVGSVGElement, MonoAppSettingsAltIconProps>(
...
MonoAppSettingsAltIcon.displayName = "MonoAppSettingsAltIcon";

...
export interface MonoFamilyRestroomIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFamilyRestroomIcon = React.forwardRef<SVGSVGElement, MonoFamilyRestroomIconProps>(
...
MonoFamilyRestroomIcon.displayName = "MonoFamilyRestroomIcon";

...
export interface MonoPieChartOutlineIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoPieChartOutlineIcon = React.forwardRef<SVGSVGElement, MonoPieChartOutlineIconProps>(
...
MonoPieChartOutlineIcon.displayName = "MonoPieChartOutlineIcon";

...
export interface MonoEvStationIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoEvStationIcon = React.forwardRef<SVGSVGElement, MonoEvStationIconProps>(
...
MonoEvStationIcon.displayName = "MonoEvStationIcon";

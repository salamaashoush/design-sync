...
export interface Mono6FtApartIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const Mono6FtApartIcon = React.forwardRef<SVGSVGElement, Mono6FtApartIconProps>(
...
Mono6FtApartIcon.displayName = "Mono6FtApartIcon";

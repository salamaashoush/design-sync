...
export interface MonoRemoveShoppingCartIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoRemoveShoppingCartIcon = React.forwardRef<SVGSVGElement, MonoRemoveShoppingCartIconProps>(
...
MonoRemoveShoppingCartIcon.displayName = "MonoRemoveShoppingCartIcon";

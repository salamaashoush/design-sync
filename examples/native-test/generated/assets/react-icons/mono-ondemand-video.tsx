...
export interface MonoOndemandVideoIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoOndemandVideoIcon = React.forwardRef<SVGSVGElement, MonoOndemandVideoIconProps>(
...
MonoOndemandVideoIcon.displayName = "MonoOndemandVideoIcon";

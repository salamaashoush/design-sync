...
export interface MonoDriveFileMoveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoDriveFileMoveIcon = React.forwardRef<SVGSVGElement, MonoDriveFileMoveIconProps>(
...
MonoDriveFileMoveIcon.displayName = "MonoDriveFileMoveIcon";

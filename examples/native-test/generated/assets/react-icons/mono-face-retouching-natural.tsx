...
export interface MonoFaceRetouchingNaturalIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoFaceRetouchingNaturalIcon = React.forwardRef<SVGSVGElement, MonoFaceRetouchingNaturalIconProps>(
...
MonoFaceRetouchingNaturalIcon.displayName = "MonoFaceRetouchingNaturalIcon";

...
export interface MonoAddLocationAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoAddLocationAltIcon = React.forwardRef<SVGSVGElement, MonoAddLocationAltIconProps>(
...
MonoAddLocationAltIcon.displayName = "MonoAddLocationAltIcon";

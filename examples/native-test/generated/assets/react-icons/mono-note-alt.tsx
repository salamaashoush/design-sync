...
export interface MonoNoteAltIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoNoteAltIcon = React.forwardRef<SVGSVGElement, MonoNoteAltIconProps>(
...
MonoNoteAltIcon.displayName = "MonoNoteAltIcon";

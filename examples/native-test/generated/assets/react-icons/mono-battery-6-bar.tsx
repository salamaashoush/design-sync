...
export interface MonoBattery6BarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoBattery6BarIcon = React.forwardRef<SVGSVGElement, MonoBattery6BarIconProps>(
...
MonoBattery6BarIcon.displayName = "MonoBattery6BarIcon";

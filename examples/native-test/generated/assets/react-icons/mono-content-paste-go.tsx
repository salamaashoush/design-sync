...
export interface MonoContentPasteGoIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoContentPasteGoIcon = React.forwardRef<SVGSVGElement, MonoContentPasteGoIconProps>(
...
MonoContentPasteGoIcon.displayName = "MonoContentPasteGoIcon";

...
export interface MonoViewKanbanIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoViewKanbanIcon = React.forwardRef<SVGSVGElement, MonoViewKanbanIconProps>(
...
MonoViewKanbanIcon.displayName = "MonoViewKanbanIcon";

...
export interface MonoWifiPasswordIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoWifiPasswordIcon = React.forwardRef<SVGSVGElement, MonoWifiPasswordIconProps>(
...
MonoWifiPasswordIcon.displayName = "MonoWifiPasswordIcon";

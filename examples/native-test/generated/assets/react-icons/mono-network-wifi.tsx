...
export interface MonoNetworkWifiIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoNetworkWifiIcon = React.forwardRef<SVGSVGElement, MonoNetworkWifiIconProps>(
...
MonoNetworkWifiIcon.displayName = "MonoNetworkWifiIcon";

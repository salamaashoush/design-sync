...
export interface MonoSavedSearchIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const MonoSavedSearchIcon = React.forwardRef<SVGSVGElement, MonoSavedSearchIconProps>(
...
MonoSavedSearchIcon.displayName = "MonoSavedSearchIcon";

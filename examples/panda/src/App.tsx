    ...
    <section className={sectionStyles}>
      ...
      <div className={spacingExampleStyles}>
        <div className={cardStyles} style={{ padding: "1rem" }}>
          <p>
            Padding: <code>kdaFoundationMd</code>
          </p>
        </div>
        <div className={cardStyles} style={{ padding: "1.5rem" }}>
          <p>
            Padding: <code>kdaFoundationLg</code>
          </p>
        </div>
        <div className={cardStyles} style={{ padding: "1.75rem" }}>
          <p>
            Padding: <code>kdaFoundationXl</code>
          </p>
        </div>
      </div>
    </section>
      ...
      <div className={sizeGridStyles}>
        {sizes.map((s) => (
          <div key={s.name} className={sizeItemStyles}>
            <div className={sizeBoxStyles} style={{ width: s.value, height: s.value }} />
            <span className={tokenNameStyles}>{s.name}</span>
          </div>
        ))}
      </div>
      ...
      <div className={radiusGridStyles}>
        {radii.map((r) => (
          <div key={r.name} className={radiusItemStyles}>
            <div className={radiusBoxStyles} style={{ borderRadius: r.value }} />
  ...
  return (
    <div className={appStyles}>
      ...
      <footer className={footerStyles}>
        <p>
          Tokens imported from <code>./tokens/preset.ts</code> via <code>designTokensPreset</code>
        </p>
      </footer>
    </div>
  );

...
import { l as loadChangelogConfig, c as getGithubChangelog, d as parseChangelogMarkdown, r as resolveGithubToken, s as syncGithubRelease } from '../shared/changelogen.b98c84ee.mjs';
import 'node:os';
import 'ofetch';
import 'scule';

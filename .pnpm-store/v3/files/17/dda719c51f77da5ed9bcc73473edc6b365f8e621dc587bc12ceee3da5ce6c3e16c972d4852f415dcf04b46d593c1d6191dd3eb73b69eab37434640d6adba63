...
import { children, createEffect, createMemo, createSignal, on, onCleanup, Show, splitProps, } from "solid-js";
    ...
    const onInputBase = (key) => {
        ...
        switch (local.segment.type) {
            ...
            case "year": {
                ...
                if ((local.segment.maxValue != null && Number(numberValue + "0") > local.segment.maxValue) ||

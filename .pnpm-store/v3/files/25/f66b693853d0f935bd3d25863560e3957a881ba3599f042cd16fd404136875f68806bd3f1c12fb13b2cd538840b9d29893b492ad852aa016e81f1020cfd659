 ...
 */
import { DateFormatter, getMinimumDayInMonth, getMinimumMonthInYear, GregorianCalendar, toCalendar, } from "@internationalized/date";
import { callHandler, mergeDefaultProps, mergeRefs } from "@kobalte/utils";
import { createEffect, createMemo, createSignal, Index, on, splitProps, } from "solid-js";
    ...
    const clearSegment = (part) => {
        ...
        if (resolvedDisplayValue && placeholder) {
            if (part === "dayPeriod" && "hour" in resolvedDisplayValue && "hour" in placeholder) {
                ...
                value = resolvedDisplayValue.set({ [part]: placeholder[part] });
            }
        }

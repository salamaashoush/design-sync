...
export declare const FormControlContext: import("solid-js").Context<FormControlContextValue>;
export declare function useFormControlContext(): FormControlContextValue;

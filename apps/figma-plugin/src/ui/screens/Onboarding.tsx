import { Button } from '@design-sync/uikit';
...
export function Onboarding() {
  ...
  return (
    <div style={{ padding: '32px 24px', display: 'flex', 'flex-direction': 'column', gap: '24px', 'align-items': 'center' }}>
      <div style={{ 'text-align': 'center' }}>
        <h2 style={{ margin: '0 0 8px' }}>Welcome to DesignSync</h2>
        <p style={{ margin: 0, opacity: 0.6 }}>Connect a Git repository to sync your design tokens</p>
      </div>

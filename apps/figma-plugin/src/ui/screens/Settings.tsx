import { Button, Dialog, EmptyState, Spinner } from "@design-sync/uikit";
      ...
      >
        <Show when={editingStorage()}>
          <StorageForm
            ...
            onSubmit={(s) => handleUpdate({ ...s, id: editingStorage()!.id } as RemoteStorage)}
          />
        </Show>
      </Dialog>
    </div>
